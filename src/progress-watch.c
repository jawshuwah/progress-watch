...
//  strftime(date_year, sizeof(date_year), "Year (%Y)", tick_time);
  ...
  strftime(date_week, sizeof(date_week), "Week %V", tick_time);
...
static void handle_init(void) {
  ...
  //Texts
    ...
    //Day
    day_layer = text_layer_create(GRect(8, 100, 128, 112));
